# my map design
# This map will show places that are improtant to me
...
["New greenland"](https://github.com/Willmakeyoupround/My-map/blob/main/My-map) This is a map that shows places in the world. The thing is that it shows places that is important to me.
...
<img src="" alt="GIF demo showing how a user can toggle through various maps and view the detailed itinerary" width="300"/>

## Why did I build this?

I wanted to make this because I wanted to show what I like to do during my spare time and where I like to go when I'm free.
